...
export const AircraftCard: React.FC<AircraftCardProps> = ({ aircraft, onBook }) => {
  ...
  return (
    <div 
      className="bg-white rounded-xl shadow-2xl drop-shadow-lg overflow-hidden hover:shadow-2xl hover:drop-shadow-2xl transition-all duration-300 cursor-pointer transform hover:scale-105 focus-within:ring-2 focus-within:ring-blue-500 flex flex-col h-full"
